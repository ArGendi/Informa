...
class _HomeScreenState extends State<HomeScreen> {
  ...
  callPaymentAPIs(AppUser user) async {
    ...
    if (token != null) {
      ...
      if (id != null) {
        String? token2 =
            await _paymentService.paymentKeyRequest(token, id, 10, user);
        if (token2 != null) {
          // Navigator.push(
          //   context,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          elevation: 0,
          title: Text(
            localization!.translate('الرئيسية').toString(),
          ),
          centerTitle: true,
          // actions: [
          //   IconButton(
                      ...
                      children: [
                        ...
                        Directionality(
                          ...
                          child: CountdownTimer(
                            endTime: activeUser
                                .premiumStartDate!.millisecondsSinceEpoch,
                            textStyle: TextStyle(
                              color: primaryColor,
                              fontSize: 14,
                              fontFamily: boldFont,
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          Text(
                            localization
                                .translate('أنضم الي عائلة أنفورما')
                                .toString(),
                            style: TextStyle(
                              fontSize: 20,
                  ...
                  child: Padding(
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'جاوب على الأسئلة علشان نعملك برنامجك الخاص',
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              fontSize: 16,
                              fontFamily: 'CairoBold',
                ...
                child: Column(
                  children: [
                    ...
                    HomeBanner(
                      ...
                      subText: 'تصفح الوجبات اللذيذة الشهية',
                    ...
                    HomeBanner(
                      ...
                      challenge: challengesProvider.challenges.isNotEmpty
                          ? challengesProvider.challenges[0]
                          : null,
                      onClick: () {
